...
let direction = "right";
let food = {
    x: Math.floor(Math.random() * 15 + 1) * box, //Math.randon numero aleatória
    y: Math.floor(Math.random() * 15 + 1) * box //Math.floor retira a parte fluente (0.1)
}
...
function update (event){
    if(event.keyCode == 37 && direction !="right") direction = "letf";
